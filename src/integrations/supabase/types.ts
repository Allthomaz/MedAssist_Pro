  ...
  public: {
    Tables: {
      ...
      document_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_history_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      document_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_templates_doctor_id_fkey"
            columns: ["doctor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      recordings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recordings_doctor_id_fkey"
            columns: ["doctor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      transcription_annotations: {
        ...
        Relationships: [
          {
            foreignKeyName: "transcription_annotations_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      transcription_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "transcription_settings_doctor_id_fkey"
            columns: ["doctor_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      transcriptions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "transcriptions_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      duplicate_template: {
        Args: { p_doctor_id: string; p_new_name: string; p_template_id: string }
        Returns: string
      }
