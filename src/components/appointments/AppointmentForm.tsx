        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">Nome do Paciente *</FormLabel>
                  <FormControl>
                    <Input 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">Telefone de Contato *</FormLabel>
                  <FormControl>
                    <Input 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="lg:col-span-2">
                  <FormLabel className="text-sm font-medium">E-mail (Opcional)</FormLabel>
                  <FormControl>
                    <Input 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col lg:col-span-1">
                  <FormLabel className="text-sm font-medium">Data do Agendamento *</FormLabel>
                  <FormControl>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium">Tipo de Consulta *</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="h-11 transition-all duration-200 hover:border-medical-blue/40 focus:border-medical-blue">
