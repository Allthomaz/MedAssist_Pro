...
export default function Analytics() {
  ...
  const performanceMetrics = [
    { label: 'Taxa de Satisfação', value: '94%', icon: Heart, color: 'text-green-500' },
    { label: 'Eficiência de Diagnóstico', value: '87%', icon: Target, color: 'text-blue-500' },
    { label: 'Tempo de Resposta', value: '2.3s', icon: Zap, color: 'text-yellow-500' },
    { label: 'Precisão da IA', value: '96%', icon: Brain, color: 'text-purple-500' }
  ];

  const recentActivities = [
    { type: 'consultation', count: 23, label: 'Consultas Hoje', icon: Stethoscope },
    { type: 'documents', count: 45, label: 'Documentos Gerados', icon: FileCheck },
    { type: 'patients', count: 12, label: 'Novos Pacientes', icon: UserCheck },
    { type: 'appointments', count: 18, label: 'Agendamentos', icon: CalendarCheck }
  ];
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Análise detalhada do desempenho e métricas do sistema</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
                ...
                <CardContent>
                  <div className="h-64 flex items-center justify-center border-2 border-dashed border-muted-foreground/25 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">Crescimento de 15% este mês</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">3 consultas precisam de atenção</p>
                    </div>
                  </div>
