-- Inserir dados corrigidos de exemplo
...
-- Inserir agendamentos (usando valores corretos das constraints)
...
-- Inserir consultas (usando colunas corretas)
INSERT INTO public.consultations (
    ...
    prescriptions, follow_up_date, status
) VALUES 
((SELECT id FROM public.patients WHERE patient_number = 'P001'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-10', '09:00:00', 30, 'Dor de cabeça frequente', 'Paciente relatou cefaleia e tontura', 'Cefaleia tensional', 'Repouso, hidratação adequada', 'Dipirona 500mg se necessário', '2024-02-10', 'finalizada'),
((SELECT id FROM public.patients WHERE patient_number = 'P002'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-12', '14:30:00', 30, 'Controle de diabetes', 'Paciente com sede excessiva e fadiga', 'Diabetes tipo 2 controlado', 'Manter dieta e exercícios', 'Metformina 850mg 2x ao dia', '2024-02-12', 'finalizada');
