-- Inserir dados completos de exemplo
...
((SELECT id FROM public.patients WHERE patient_number = 'P001'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-15', '09:00:00', 'consulta', 'scheduled', 'Consulta de rotina'),
((SELECT id FROM public.patients WHERE patient_number = 'P002'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-16', '14:30:00', 'retorno', 'scheduled', 'Acompanhamento diabetes'),
((SELECT id FROM public.patients WHERE patient_number = 'P003'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-17', '10:15:00', 'consulta', 'completed', 'Consulta para asma');

-- Inserir consultas
INSERT INTO public.consultations (
    patient_id, doctor_id, consultation_date, consultation_time,
    chief_complaint, symptoms, diagnosis, treatment_plan, 
    prescription, follow_up_date, notes, status
) VALUES 
((SELECT id FROM public.patients WHERE patient_number = 'P001'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-10', '09:00:00', 'Dor de cabeça frequente', 'Cefaleia, tontura', 'Cefaleia tensional', 'Repouso, hidratação adequada', 'Dipirona 500mg se necessário', '2024-02-10', 'Paciente relatou melhora dos sintomas', 'completed'),
((SELECT id FROM public.patients WHERE patient_number = 'P002'), 'ef14284c-594f-40d4-92ac-8f83f8f83ce3', '2024-01-12', '14:30:00', 'Controle de diabetes', 'Sede excessiva, fadiga', 'Diabetes tipo 2 controlado', 'Manter dieta e exercícios', 'Metformina 850mg 2x ao dia', '2024-02-12', 'Glicemia dentro dos parâmetros', 'completed');
